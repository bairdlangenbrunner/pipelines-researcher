...
const A = {"repo": "/Users/baird/Dropbox/_git_ALL/_github-repos-gem/pipelines-researcher", "staging": "batches/libya-gas/staging/annual", "commodity": "gas", "country": "Libya", "pids": ["P6707", "P6708", "P6715", "P6716", "P7102", "P7617"], "roster": ["P6707 | Sirte Gulf PS Gas Pipeline | Brega->Sirte Gulf | len=5.0 dia=24 cap=? | status=construction | updated=2025-08-20", "P6708 | NC 41-Mellitah Gas Pipeline | ?->? | len=130.0 dia=30 cap=? | status=construction | updated=2025-08-20", "P6715 | E Structure-Mellitah Gas Pipeline | ?->? | len=130.0 dia=32 cap=? | status=construction | updated=2025-08-20", "P6716 | DP3–DP4–Sabratha Gas Pipeline | ?->? | len=8.5 dia=14 cap=? | status=construction | updated=2025-08-19", "P7102 | Nigeria–Libya Gas Pipeline | ?->? | len=? dia=? cap=? | status=proposed | updated=2025-08-19", "P7617 | DP3–DP4–Sabratha Gas Pipeline | Bouri Platform->? | len=20.0 dia=10,4 cap=? | status=construction | updated=2025-08-19"], "status_review": true, "model": "sonnet"}
