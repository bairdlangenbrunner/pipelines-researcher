export const meta = {
  name: 'egypt-gas-annual-indev-deepsweep',
...
const A = {
 ...
 "roster": [
  "P3620 | Israel\u2013Egypt Onshore Gas Pipeline | Ramat Hovav->? | len=65.0 dia=? cap=6.0 | status=construction | updated=2025-08-11",
  "P3657 | Israel\u2013Egypt Offshore Gas Pipeline | ?->? | len=? dia=? cap=6.7 | status=proposed | updated=2025-08-11",
  "P0473 | Cyprus\u2013Egypt Gas Pipeline | Aphrodite offshore gas field->Damietta | len=310.0 dia=? cap=8.0 | status=proposed | updated=2025-08-11",
  "P7597 | Cronos-Port Said Gas Pipeline | ?->Port Said | len=90.0 dia=? cap=500.0 | status=proposed | updated=2025-08-14",
  "P7864 | Nitzana Pipeline | ?->? | len=65.0 dia=36 cap=600.0 | status=proposed | updated=2025-12-23",
  "P6685 | Solaimaneyah-North Giza Gas Pipeline | Solaimaneyah->Giza | len=20.0 dia=42 cap=? | status=construction | updated=2025-08-30",
  "P6686 | New Fayoum Gas Pipeline | New Fayoum City->Fayoum | len=40.0 dia=16,24 cap=? | status=construction | updated=2025-08-11"
 ],
 "status_review": true
}
