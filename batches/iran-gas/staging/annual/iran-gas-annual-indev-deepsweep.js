...
const A = {
 ...
 "roster": [
  "P2225 | Iran-Oman Gas Pipeline | Rudan County->Al Batinah North | len=1000.0 dia=? cap=10.0 | status=construction | updated=2025-07-17",
  "P6848 | Dauletabad-Sarakhs-Khangiran Gas Pipeline | Dauletabad->Khorasan Khorasan Province | len=125.0 dia=? cap=19.5 | status=proposed | updated=2025-09-08",
  "P7104 | Russia–Iran Gas Pipeline | ?->? | len=? dia=? cap=55.0 | status=construction | updated=2025-07-18",
  "P0441 | IGAT 11 Gas Pipeline | Asaluyeh->Azerbaijan | len=1200.0 dia=56 cap=110.0 | status=construction | updated=2025-09-04",
  "P0452 | Iran-Pakistan Pipeline | Asaluyeh->Sindh | len=2775.0 dia=56 cap=750.0 | status=construction | updated=2025-07-11",
  "P3174 | Off-Shore Gas Pipeline | ?->? | len=1500.0 dia=? cap=1000.0 | status=proposed | updated=2025-07-22",
  "P0448 | IGAT 9 Gas Pipeline | Asaluyeh->West Azerbaijan Province | len=1900.0 dia=56 cap=3885.0 | status=construction | updated=2025-07-11",
  "P6006 | Behbahan–Gachsaran Gas Pipeline | ?->? | len=62.0 dia=20 cap=? | status=construction | updated=2025-07-23"
 ],
 "status_review": true
}
